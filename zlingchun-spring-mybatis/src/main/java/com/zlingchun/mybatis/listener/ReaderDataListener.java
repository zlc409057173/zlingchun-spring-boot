...
@Slf4j
public class ReaderDataListener implements ReadListener<ReaderData> {
    Snowflake snowflake;
    ReaderDataService dataService;

    public ReaderDataListener() {
    }

    public ReaderDataListener(Snowflake snowflake, ReaderDataService dataService) {
