...
public class CustomerDto implements Serializable {
     ...
     * 客户名称
     */
    @ApiModelProperty(name = "cusName", value = "客户名称", position = 1, required = false)
     ...
     * 创建人
     */
    @ApiModelProperty(name = "createBy", value = "创建人", position = 8, required = false, hidden=true)
    private String createBy;
    /**
     * 创建时间
     */
    @ApiModelProperty(name = "createTime", value = "创建时间", position = 9, required = false, hidden=true)
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private String createTime;
    /**
     * 更新人
     */
    @ApiModelProperty(name = "updateBy", value = "更新人", position = 10, required = false, hidden=true)
    private String updateBy;
    /**
     * 更新时间
     */
    @ApiModelProperty(name = "createTime", value = "更新时间", position = 11, required = false, hidden=true)
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
